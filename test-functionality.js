async function testAppFunctionality() {
  ...
  try {
    ...
    const features = [
      ...
      { name: 'Updates/Stories', keywords: ['update', 'story', 'updates-stories'] },
      { name: 'Media Support', keywords: ['media', 'image', 'video', 'media-support'] },
      { name: 'Voice Messages', keywords: ['voice', 'audio', 'voice-messages'] },
      { name: 'Firebase Integration', keywords: ['firebase', 'firebase-integration'] },
      { name: 'User Authentication', keywords: ['auth', 'login', 'user-authentication'] },
      { name: 'Real-time Features', keywords: ['socket', 'realtime', 'realtime-features'] }
    ];
