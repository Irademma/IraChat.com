...
// Helper functions
export const getResponsiveValue = (small: any, medium?: any, large?: any, tablet?: any) => {
...
export const getResponsiveStyle = (baseStyle: any, responsiveOverrides: any = {}) => {
  const deviceType = isTablet() ? 'tablet' : isLargeDevice() ? 'large' : isSmallDevice() ? 'small' : 'medium';
  return {
    ...baseStyle,
