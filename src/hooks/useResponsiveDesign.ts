...
export function useResponsiveSpacing() {
  ...
  return {
    ...
    containerPadding: breakpoints.isXS ? 12 :
                     breakpoints.isSM ? 16 :
                     breakpoints.isMD ? 20 :
                     breakpoints.isLG ? 24 :
                     breakpoints.isXL ? 32 :
                     breakpoints.isXXL ? 40 : 48,

    // Section spacing
    sectionSpacing: breakpoints.isXS ? 12 :
                   breakpoints.isSM ? 16 :
                   breakpoints.isMD ? 20 :
                   breakpoints.isLG ? 24 :
                   breakpoints.isXL ? 32 :
    ...
    // Item spacing
    itemSpacing: breakpoints.isXS ? 6 :
                breakpoints.isSM ? 8 :
                breakpoints.isMD ? 10 :
                breakpoints.isLG ? 12 :
                breakpoints.isXL ? 16 :
                breakpoints.isXXL ? 20 : 24,

    // Button padding
    buttonPadding: {
      horizontal: breakpoints.isXS ? 12 :
                 breakpoints.isSM ? 16 :
                 breakpoints.isMD ? 20 :
                 breakpoints.isLG ? 24 :
                 breakpoints.isXL ? 28 :
                 breakpoints.isXXL ? 32 : 36,
      vertical: breakpoints.isXS ? 8 :
               breakpoints.isSM ? 10 :
               breakpoints.isMD ? 12 :
               breakpoints.isLG ? 14 :
               breakpoints.isXL ? 16 :
               breakpoints.isXXL ? 18 : 20,
    },

    // Input padding
    inputPadding: {
      horizontal: breakpoints.isXS ? 10 :
                 breakpoints.isSM ? 12 :
                 breakpoints.isMD ? 16 :
                 breakpoints.isLG ? 20 :
                 breakpoints.isXL ? 24 :
                 breakpoints.isXXL ? 28 : 32,
      vertical: breakpoints.isXS ? 8 :
               breakpoints.isSM ? 10 :
               breakpoints.isMD ? 12 :
               breakpoints.isLG ? 14 :
    ...
    // Safe area padding
    safeArea: breakpoints.isXS ? 8 :
             breakpoints.isSM ? 12 :
             breakpoints.isMD ? 16 : 20,
...
export function useResponsiveFontSizes() {
  ...
  const baseSizes = {
    xs: breakpoints.isXS ? 10 :
        breakpoints.isSM ? 11 :
        breakpoints.isMD ? 12 :
        breakpoints.isLG ? 13 :
        breakpoints.isXL ? 14 :
        breakpoints.isXXL ? 15 : 16,
    sm: breakpoints.isXS ? 12 :
        breakpoints.isSM ? 13 :
        breakpoints.isMD ? 14 :
        breakpoints.isLG ? 15 :
        breakpoints.isXL ? 16 :
        breakpoints.isXXL ? 17 : 18,
    base: breakpoints.isXS ? 14 :
          breakpoints.isSM ? 15 :
          breakpoints.isMD ? 16 :
          breakpoints.isLG ? 17 :
          breakpoints.isXL ? 18 :
          breakpoints.isXXL ? 19 : 20,
    lg: breakpoints.isXS ? 16 :
        breakpoints.isSM ? 17 :
        breakpoints.isMD ? 18 :
        breakpoints.isLG ? 20 :
        breakpoints.isXL ? 22 :
        breakpoints.isXXL ? 24 : 26,
    xl: breakpoints.isXS ? 18 :
        breakpoints.isSM ? 19 :
        breakpoints.isMD ? 20 :
        breakpoints.isLG ? 22 :
        breakpoints.isXL ? 24 :
        breakpoints.isXXL ? 26 : 28,
    '2xl': breakpoints.isXS ? 20 :
           breakpoints.isSM ? 22 :
           breakpoints.isMD ? 24 :
           breakpoints.isLG ? 28 :
           breakpoints.isXL ? 32 :
           breakpoints.isXXL ? 36 : 40,
    '3xl': breakpoints.isXS ? 24 :
           breakpoints.isSM ? 28 :
           breakpoints.isMD ? 30 :
           breakpoints.isLG ? 36 :
           breakpoints.isXL ? 42 :
           breakpoints.isXXL ? 48 : 54,
    '4xl': breakpoints.isXS ? 28 :
           breakpoints.isSM ? 32 :
           breakpoints.isMD ? 36 :
           breakpoints.isLG ? 42 :
           breakpoints.isXL ? 48 :
           breakpoints.isXXL ? 56 : 64,
  };
...
export function useResponsiveLayout() {
  ...
  return {
    ...
    gridColumns: breakpoints.isXS ? 1 :
                breakpoints.isSM ? 1 :
                breakpoints.isMD ? 2 :
                breakpoints.isLG ? 2 :
                breakpoints.isXL ? 3 :
                breakpoints.isXXL ? 4 : 5,

    // Max content width - responsive for all devices
    maxContentWidth: breakpoints.isXS ? '100%' :
                    breakpoints.isSM ? '100%' :
                    breakpoints.isMD ? 600 :
                    breakpoints.isLG ? 800 :
                    breakpoints.isXL ? 1000 :
                    breakpoints.isXXL ? 1200 : 1400,

    // Chat list layout
    chatListColumns: deviceType === 'desktop' && orientation === 'landscape' ? 2 : 1,

    // Tab bar layout - responsive heights
    tabBarHeight: breakpoints.isXS ? 56 :
                 breakpoints.isSM ? 60 :
                 breakpoints.isMD ? 64 :
                 breakpoints.isLG ? 68 :
                 breakpoints.isXL ? 72 : 76,

    // Header height - responsive
    headerHeight: breakpoints.isXS ? 52 :
                 breakpoints.isSM ? 56 :
                 breakpoints.isMD ? 60 :
                 breakpoints.isLG ? 64 :
                 breakpoints.isXL ? 68 : 72,

    // Modal sizing - enhanced responsiveness
    modalWidth: breakpoints.isXS ? '98%' :
               breakpoints.isSM ? '95%' :
               breakpoints.isMD ? '85%' :
               breakpoints.isLG ? '75%' :
               breakpoints.isXL ? '65%' :
               breakpoints.isXXL ? '55%' : '45%',
    modalMaxWidth: breakpoints.isXS ? 350 :
                  breakpoints.isSM ? 400 :
                  breakpoints.isMD ? 500 :
                  breakpoints.isLG ? 600 :
                  breakpoints.isXL ? 700 :
                  breakpoints.isXXL ? 800 : 900,
    modalMaxHeight: '90%',
    modalMinHeight: breakpoints.isXS ? 200 :
                   breakpoints.isSM ? 250 :
                   breakpoints.isMD ? 300 : 350,

    // Card layout
    cardPadding: breakpoints.isXS ? 12 :
                breakpoints.isSM ? 16 :
                breakpoints.isMD ? 20 :
                breakpoints.isLG ? 24 : 28,
    cardMargin: breakpoints.isXS ? 8 :
               breakpoints.isSM ? 12 :
               breakpoints.isMD ? 16 : 20,
    borderRadius: breakpoints.isXS ? 8 :
                 breakpoints.isSM ? 10 :
                 breakpoints.isMD ? 12 :
                 breakpoints.isLG ? 14 : 16,
  };
}
